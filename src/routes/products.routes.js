...
import { validateProductUpdate } from "../middlewares/validateProductUpdate.js"
...
router.put("/api/products/:id", authMiddleware, requireRole("admin"), upload.single("image"), validateProductUpdate, productsController.updateProduct)
